# -------------------------------------------------------------
# 📄 Simulador de Salário Líquido e Custo do Empregador (v2025.50.16)
...
CONFIG_DIR = "." 
# (Se os JSONs estiverem em uma subpasta, mude '.' para o nome da pasta)
# Ex: CONFIG_DIR = os.path.dirname(os.path.abspath(__file__))
...
with st.sidebar:
    ...
    # Encontra o índice do país salvo
