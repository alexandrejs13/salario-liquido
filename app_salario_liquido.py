# -------------------------------------------------------------
# 📄 Simulador de Salário Líquido e Custo do Empregador (v2025.50.34 - FIX CRÍTICO FINAL)
# Correção: Removido caractere invisível/erro de sintaxe no COUNTRIES_FALLBACK.
# -------------------------------------------------------------
...
# --- Fallbacks Mínimos (COM CARACTERES INVISÍVEIS REMOVIDOS) ---
...
.annual-card-base {
    min-height: 95px !important; /* Volta para o tamanho do metric-card */
    padding: 8px 12px !important; /* Volta para o padding do metric-card */
    display: flex;
...
.annual-card-base h3 {
    font-size: 17px !important; /* Volta para o tamanho do metric-card */
    font-weight: 700;
...
if active_menu == T.get("menu_calc"):
    ...
    with col_chart:
        ...
        base = alt.Chart(chart_df).transform_joinaggregate(
            ...
            # CORREÇÃO: Usando a template string nativa para formar o rótulo
