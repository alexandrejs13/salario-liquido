...
# CORREÇÃO: Lógica robusta para extrair COUNTRIES
if isinstance(COUNTRIES_DATA, dict) and "countries" in COUNTRIES_DATA and isinstance(COUNTRIES_DATA["countries"], dict):
    COUNTRIES = COUNTRIES_DATA["countries"]
else:
    print("Warning: 'countries.json' não tem a chave 'countries' ou está malformado. Usando fallback.")
