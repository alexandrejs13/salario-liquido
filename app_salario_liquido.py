# -------------------------------------------------------------
# 📄 Simulador de Salário Líquido e Custo do Empregador (v2025.50.49 - FIX DEFINITIVO DE LAYOUT/ESTABILIDADE)
# Correção: Inicialização de 'dependentes' no bloco de Custos (NameError) e aplicação consistente dos 5 pontos de design.
# -------------------------------------------------------------
...
if active_menu == T.get("menu_calc"):
    ...
    with col_cards:
        ...
        # FIX 1/5: Cards alinhados verticalmente, sem emoji duplicado
