# -------------------------------------------------------------
# 📄 Simulador de Salário Líquido e Custo do Empregador (v2025.50.33 - FIX ALTAIR + UNIFICAÇÃO DE CARDS)
# Correção: Corrigido o AttributeError 'alt.format' no gráfico de pizza e padronizado o estilo dos cards.
# -------------------------------------------------------------
