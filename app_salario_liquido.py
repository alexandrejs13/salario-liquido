# -------------------------------------------------------------
# 📄 Simulador de Salário Líquido e Custo do Empregador (v2025.50.43 - FIX DEFINITIVO DE LAYOUT/CARDS)
# Correção: Padronização total dos cards anuais com a estética dos cards mensais e correção da duplicação de emojis.
# -------------------------------------------------------------
...
if active_menu == T.get("menu_calc"):
    ...
    # FIX 3: Divisor acima do título da seção de remuneração mensal (novo posicionamento)
    st.write("---") 
