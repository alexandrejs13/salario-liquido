# -------------------------------------------------------------
# 📄 Simulador de Salário Líquido e Custo do Empregador (v2025.50.51 - FIX FINAL DE NOMEAMENTO E ESPAÇAMENTO)
# Correção: Solucionado o SyntaxError U+00A0 e aplicado o layout final dos cards anuais.
# -------------------------------------------------------------
