# -------------------------------------------------------------
# 📄 Simulador de Salário Líquido e Custo do Empregador (v2025.50.48 - FIX FINAL ESTABILIDADE/LAYOUT)
# Correção: Inicialização de fallbacks corrigida e aplicação consistente dos 5 pontos de design.
# -------------------------------------------------------------
...
# --- Fallbacks Mínimos (Mantidos com correção U+00A0 e booleanos) ---
