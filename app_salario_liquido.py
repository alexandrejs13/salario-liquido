# -------------------------------------------------------------
# 📄 Simulador de Salário Líquido e Custo do Empregador (v2025.50.49 - CORREÇÃO CRÍTICA SIMULADOR)
# CORREÇÃO: Resolvido NameError na página "Simulador de Remuneração" padronizando a variável 'salary'.
...
# ======================= TÍTULO DINÂMICO ==============================
title_map = {
    T.get("menu_calc", "Simulador de Remuneração"): T.get("title_calc", "Simulador de Remuneração"),
    T.get("menu_comp", "Comparador de Remuneração"): T.get("title_comp", "Comparador de Remuneração"),
    T.get("menu_rules", "Regras de Contribuições"): T.get("title_rules", "Regras de Contribuições"),
    T.get("menu_rules_sti", "Regras de Cálculo do STI"): T.get("title_rules_sti", "Regras de Cálculo do STI"),
    T.get("menu_cost", "Custo do Empregador"): T.get("title_cost", "Custo do Empregador")
}
title = title_map.get(active_menu)
