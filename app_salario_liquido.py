# -------------------------------------------------------------
# 📄 Simulador de Salário Líquido e Custo do Empregador (v2025.50.42 - FIX FINAL DE DETALHES CRÍTICOS)
# Correção: Layout Anual reescrito, padronização TOTAL dos cards e formatação da tabela.
# -------------------------------------------------------------
...
/* 4. Estilo para a grade de cards anuais */
/* Não usamos .annual-grid para os containers de coluna, mas mantemos o estilo interno dos cards */

/* 5. Estilo de Tabela (Para Remuneração Mensal E Contribuições) */
.table-wrap {
    background:#fff; 
...
if active_menu == T.get("menu_calc"):
    ...
    # FIX 1: Emojis únicos nos cards mensais
