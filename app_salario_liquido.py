...
def load_tables_data(): # Função agora apenas organiza os dados já carregados
    country_tables_dict = {
...
with st.sidebar:
    ...
    st.markdown(f"<h3 style='margin-bottom: 0.5rem;'>{I18N.get('Português', {}).get('language_title', '🌐 Idioma / Language / Idioma')}</h3>", unsafe_allow_html=True) # Fallback
