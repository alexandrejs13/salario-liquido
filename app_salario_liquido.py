# -------------------------------------------------------------
# 📄 Simulador de Salário Líquido e Custo do Empregador (v2025.50.22 - NameError FIX)
# Ordem das funções de cálculo movidas para o topo (antes da Sidebar)
# -------------------------------------------------------------
...
# --- CORREÇÃO DE ESCOPO/NAMEERROR: Recuperando T e active_menu ---
...
if active_menu == T.get("menu_calc"):
    ...
    if country == "Brasil":
        ...
        <div style="display: flex; justify-content: space-between;">
            ...
            <div style="width: 16.66%;"><h5>{T.get('dependentes', 'Dependentes')}<br>(IR)</h5></div>
