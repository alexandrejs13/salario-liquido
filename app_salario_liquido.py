...
if active_menu == T.get("menu_calc"):
    ...
    col_cards, col_chart = st.columns([1, 1.5]) # Layout 1:1.5 para dar mais espaço ao gráfico, empurrando-o para a direita e liberando mais espaço para os cards
    ...
    with col_cards:
        ...
        # Card Salário (1)
        c_label2, c_value2 = st.columns([1.5, 1]) # Aumenta a largura do rótulo para aumentar o card e dar mais espaçamento horizontal
        c_label2.markdown(f"""
...
c_label3, c_value3 = st.columns([1.5, 1]) # Aumenta a largura do rótulo para aumentar o card e dar mais espaçamento horizontal
        c_label3.markdown(f"""
        ...
        st.markdown("<div style='margin-top: 1rem;'></div>", unsafe_allow_html=True) # Espaçamento vertical entre cards
c_label1, c_value1 = st.columns([1.5, 1]) # Aumenta a largura do rótulo para aumentar o card e dar mais espaçamento horizontal
        c_label1.markdown(f"""
