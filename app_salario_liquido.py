# -------------------------------------------------------------
# 📄 Simulador de Salário Líquido e Custo do Empregador (v2025.50.49 - FIX FINAL DE ALINHAMENTO E ESTRUTURA)
# Correção: Solucionado o NameError em COUNTRIES_FALLBACK e aplicado o layout final dos cards anuais.
# -------------------------------------------------------------
...
if active_menu == T.get("menu_calc"):
    ...
    with col_cards:
        ...
        """, unsafe_allow_html=True)
        c_value2.markdown(f"""
        <div class='annual-card-base annual-card-value' style='border-left-color: #28a745; background: #e6ffe6; margin-bottom: 5px; text-align: right;'>
