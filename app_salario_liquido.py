# -------------------------------------------------------------
# 📄 Simulador de Salário Líquido e Custo do Empregador (v2025.50.39 - FIX DEFINITIVO DE CARDS)
# Correção: Reescrita da seção Anual Comp para usar sub-colunas, garantindo a renderização HTML.
# -------------------------------------------------------------
...
if active_menu == T.get("menu_calc"):
    ...
    with col_cards:
        ...
        # CORREÇÃO CRÍTICA: Estrutura HTML COMPLETA na string de marcação.
        html_cards = f"""
        <div class="annual-grid">
            ...
            <div class='annual-card-base annual-card-label' style='border-left-color: #28a745; background: #e6ffe6;'>
                ...
                <span class='sti-note'>({T.get('months_factor','Meses')}: {months})</span>
            </div>
