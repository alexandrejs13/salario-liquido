# -------------------------------------------------------------
# 📄 Simulador de Salário Líquido e Custo do Empregador (v2025.50.31 - REFINAMENTO DE LAYOUT V2)
# Correção: Reduzida a largura máxima do contêiner principal para maior elegância.
# -------------------------------------------------------------
