# -------------------------------------------------------------
# 📄 Simulador de Salário Líquido e Custo do Empregador (v2025.50.30 - FIX DE LAYOUT CENTRALIZADO)
# Correção: Adicionado CSS para limitar a largura máxima e centralizar o conteúdo.
# -------------------------------------------------------------
...
st.markdown("""
<style>
/* 1. LIMITA LARGURA MÁXIMA E CENTRALIZA O CONTEÚDO PRINCIPAL */
div.block-container {
    max-width: 1400px; /* Defina sua largura máxima desejada aqui */
    padding-left: 1rem;
    padding-right: 1rem;
}

/* 2. AJUSTE NO ESTILO DOS TÍTULOS */
.stMarkdown h5 {
    font-size: 14px; 
    font-weight: 500; 
    line-height: 1.2; 
