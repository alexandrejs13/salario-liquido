# -------------------------------------------------------------
# 📄 Simulador de Salário Líquido e Custo do Empregador (v2025.50.28 - FIX FINAL GERAL)
# Correção: Mover INPUT_FORMAT para o escopo global.
# -------------------------------------------------------------
...
    c2.markdown(f"<div class='annual-card-base annual-card-value' style='border-left-color: #28a745; background: #e6ffe6;'><h3>{fmt_money(salario_anual, symbol)}</h3></h3></div>", unsafe_allow_html=True)
