...
# Correção: Remoção de emojis duplicados, alinhamento dos cards anuais e formatação da tabela mensal.
# -------------------------------------------------------------
...
.annual-card-base {
    ...
    /* FIX 5: Espaçamento para igualar ao metric-card abaixo */
    margin-bottom: 10px; 
}
.annual-card-base h3 {
...
.annual-grid {
    ...
    gap: 10px; 
    /* Margem inferior removida para evitar espaçamento duplo na coluna */
}

/* FIX 5: Assegura que o texto do label (título e nota) fique centralizado verticalmente */
.annual-card-label {
