# -------------------------------------------------------------
# 📄 Simulador de Salário Líquido e Custo do Empregador (v2025.50.29 - FIX CRÍTICO U+00A0)
# Correção: Removido caractere invisível U+00A0 (Non-breaking space) dos fallbacks JSON.
# -------------------------------------------------------------
...
if active_menu == T.get("menu_calc"):
    ...
    if country == "Brasil":
        ...
        cols = st.columns(4) 
        # APLICANDO FORMATO (USO DE INPUT_FORMAT DEFINIDO NO TOPO)
