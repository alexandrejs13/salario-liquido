# -------------------------------------------------------------
# 📄 Simulador de Salário Líquido e Custo do Empregador (v2025.50.40 - FIX FINAL DE RENDERIZAÇÃO)
# Correção: Layout Anual reescrito usando sub-colunas Streamlit (nativo) para máxima estabilidade e renderização correta dos cards.
# -------------------------------------------------------------
...
.annual-card-base {
    ...
    margin-bottom: 10px; /* Espaçamento entre os cards, removido do grid anterior */
}
.annual-card-base h3 {
...
.annual-grid-container {
    /* Container que hospeda os 6 cards em 3 linhas x 2 colunas */
    display: grid; 
...
.annual-grid-item {
    display: contents; /* Permite que os filhos (os cards) sigam o grid pai */
}
